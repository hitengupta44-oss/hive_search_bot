  ...
  const benefits = [
    {
      ...
      description: "Rigorous quality control ensuring near-perfect ground truth data.",
    },
    {
      icon: Shield,
      title: "Data Security",
      description: "Compliant and secure labeling environments for sensitive information.",
    },
    {
      icon: Zap,
      title: "Rapid Turnaround",
      description: "Scalable workforce to handle massive datasets in record time.",
    },
    {
      icon: FileSearch,
      title: "Diverse Datasets",
      description: "Expertise across 15+ languages and multiple industry domains.",
    },
  ];
