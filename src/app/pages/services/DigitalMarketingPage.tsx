  ...
  const benefits = [
    {
      ...
      description: "Full funnel tracking to see exactly where your revenue comes from.",
    },
    {
      icon: Search,
      title: "Organic Growth",
      description: "Building long-term sustainable traffic through organic search.",
    },
    {
      icon: Share2,
      title: "Brand Authority",
      description: "Establishing your brand as the thought leader in your industry.",
    },
    {
      icon: BarChart3,
      title: "Real-time Analytics",
      description: "Live dashboards to monitor campaign performance daily.",
    },
  ];
