  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* <section className="pb-24">
        <div className="container mx-auto px-4">
          <div className="bg-slate-900 rounded-2xl p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="relative z-10 max-w-2xl text-center md:text-left">
              <h2 className="text-3xl md:text-5xl font-black text-white mb-6">Need a custom <br /><span className="text-emerald-400">Enterprise Solution?</span></h2>
              <p className="text-slate-400 text-lg font-medium leading-relaxed">
                Unlimited pages, custom CMS workflows, intricate API integrations and dedicated support. Let's discuss your custom scale.
              </p>
            </div>
            <Link 
              to="/contact"
              className="relative z-10 px-6 py-3 md:px-10 md:py-5 bg-white text-slate-900 rounded-2xl font-black text-sm md:text-xl hover:scale-105 transition-transform whitespace-nowrap"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {marketingPlans.map((plan, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all">
                ...
                <Link to="/contact" className="block text-center py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-emerald-600 transition-colors">Select Plan</Link>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border border-gray-100">
            ...
            <div className="mt-12 p-6 bg-emerald-50 rounded-2xl border border-emerald-100 text-center">
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-3 bg-emerald-600 text-white rounded-xl font-black hover:bg-emerald-700 transition-colors">
                ...
                >
                  ...
                  >
                    <h4 className="text-lg font-black text-gray-900 flex gap-4">
                      <HelpCircle className={`text-emerald-500 flex-shrink-0 transition-transform ${isOpen ? "rotate-12" : ""}`} /> {f.q}
                    </h4>
